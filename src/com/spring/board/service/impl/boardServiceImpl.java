...
public class boardServiceImpl implements boardService{
	...
	@Override
	public int boardInsert(String[] boardType, String[] boardTitle, String[] boardComment,
		...
		for(int i=0;i<boardType.length;i++) {
			...
			boardVo.setCreator(creator[i]);
			result.add(boardVo);
		}

		return boardDao.boardInsert(result);
	}
